...
void Shader::SetFloat3(const std::string& name, glm::vec3 vector3)
{
    GLCall(glUniform3fv(GetUniformLocation(name), 1, glm::value_ptr(vector3)));
}

void Shader::SetMat4(const std::string& name, glm::mat4 matrix4x4)
{
