...
int main(void)
{
    ...
    
    {
        ...
        Entity* teapotEntity = game->spawn_entity<Entity>(glm::vec3(3), &teapotMesh, &shader, &camera);
        Entity* teapotEntity2 = game->spawn_entity<Entity>(glm::vec3(-3), &teapotMesh, &shader, &camera);
